...
" }"))
        ...
        self.buttonCreateAppLocal = QtGui.QPushButton(self.widget)
        self.buttonCreateAppLocal.setObjectName(_fromUtf8("buttonCreateAppLocal"))
        self.horizontalLayout_2.addWidget(self.buttonCreateAppLocal)
